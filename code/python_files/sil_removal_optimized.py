...
#voiced_only = np.delete(voiced_feat, (1061, 1430, 1500, 1552, 1566, 1574, 1575, 1576, 1862, 1863, 1864, 1865, 1868, 1869,
...
def attention_model():
    model = Sequential()
    #model.add(Dropout(0.2, input_shape=(100, 34)))
    ...
    rmsprop = keras.optimizers.RMSprop(lr=0.002, rho=0.9, epsilon=None, decay=0.0)
...
#plt.plot(acc1)
#plt.savefig('accuracy_optimized_006_001.pdf')
#seed = 
